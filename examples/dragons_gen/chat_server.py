...
from dialogs_framework import run_gen_dialog, InMemoryPersistence, dialog
...
def intelligent_dialog():
    name = yield prompt("Hey! What's your name?")
...
class ChatServer:
    ...
    def get_server_messages(self, client_response):
        ...
        dialog_step = run_gen_dialog(main_dialog, self.persistence, client_response)
